...
- (STLocation *)locationObjectFromCLLocation:(CLLocation *)location {
    ...
    STLocation *locationObject = (STLocation *)[NSEntityDescription insertNewObjectForEntityForName:NSStringFromClass([STLocation class]) inManagedObjectContext:self.document.managedObjectContext];
