...
#import "STBatteryStatus.h"

@implementation STBatteryTracker
...
- (void)getBatteryStatus {
    ...
    STBatteryStatus *batteryStatus = (STBatteryStatus *)[NSEntityDescription insertNewObjectForEntityForName:@"STBatteryStatus" inManagedObjectContext:self.document.managedObjectContext];
