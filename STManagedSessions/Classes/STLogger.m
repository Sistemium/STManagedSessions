...
@property (strong, nonatomic) STDocument *document;
...
- (void)setDocument:(STDocument *)document {
...
- (void)saveLogMessageWithText:(NSString *)text type:(NSString *)type {
    ...
    STLogMessage *logMessage = (STLogMessage *)[NSEntityDescription insertNewObjectForEntityForName:NSStringFromClass([STLogMessage class]) inManagedObjectContext:self.document.managedObjectContext];
    logMessage.text = text;
    logMessage.type = type;
    
    NSLog(@"%@ %@", NSStringFromClass([STLogMessage class]),  text);
